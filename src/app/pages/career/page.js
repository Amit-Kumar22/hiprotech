          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-blue-600">Values</h3>
                  <p className="text-gray-700">
                    We value innovation, collaboration, and a passion for empowering the next generation of tech leaders.
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-blue-600">Vision</h3>
                  <p className="text-gray-700">
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <div className="bg-indigo-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-indigo-700">Healthcare</h3>
                <p className="text-gray-700">Comprehensive health insurance plans for employees and their families.</p>
              </div>
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-green-700">Paid Time Off</h3>
                <p className="text-gray-700">Generous vacation and sick leave policies.</p>
              </div>
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-blue-700">Professional Growth</h3>
                <p className="text-gray-700">Opportunities for training, workshops, and conferences.</p>
              </div>
              <div className="bg-purple-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-purple-700">Flexibility</h3>
                <p className="text-gray-700">Options for remote work and flexible hours.</p>
              </div>
            </div>
          </div>
        </section>
