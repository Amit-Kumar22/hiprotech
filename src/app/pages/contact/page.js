  ...
  return (
    <div>
      <Head>
        ...
        <link rel="canonical" href="https://hiprotech.in/pages/contact" />
        <meta property="og:title" content="Contact Hiprotech | Robotics, Drones, and AI Solutions" />
        ...
        <meta property="og:url" content="https://hiprotech.in/pages/contact" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/RobotLogin.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Contact Hiprotech | Robotics, Drones, and AI Solutions" />
        <meta name="twitter:description" content="Contact Hiprotech for robotics, drones, and AI solutions. Get in touch to discuss your needs or request more information." />
                ...
                <div className="space-y-8">
                  ...
                  <div className="pt-4">
                    ...
                    <div className="flex space-x-4">
                      {/* Facebook */}
                      <a href="https://www.facebook.com/share/16UZicJHnu/?mibextid=wwXIfr" aria-label="Facebook" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition duration-300 transform hover:scale-110">
                      ...
                      {/* LinkedIn */}
                      <a href="http://linkedin.com/in/abhishek-kumar-b52975177" aria-label="LinkedIn" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition duration-300 transform hover:scale-110">
                      ...
                      {/* Instagram */}
                      <a href="https://www.instagram.com/abhishekjantaa?igsh=MWNsNDh5bWNyaDIweg==" aria-label="Instagram" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition duration-300 transform hover:scale-110">
                      ...
                      {/* YouTube */}
                      <a href="https://www.youtube.com/@jantagroup7987" aria-label="YouTube" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition duration-300 transform hover:scale-110">
