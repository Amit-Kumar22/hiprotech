            ...
            <main className="font-sans bg-white text-gray-800">
                ...
                <section className="relative h-[400px] md:h-[500px] overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-0">
                        <Image
                            src={getImagePath("/drone/school8.jpg")}
                ...
                <section className="py-12 px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { title: "Consumer", color: "green", image: getImagePath("/drone/school2.png") },
                        { title: "Innovator", color: "blue", image: getImagePath("/drone/school3.png") },
                        { title: "Creator", color: "red", image: getImagePath("/drone/school4.png") },
                    ].map((item, idx) => (
                        <div
                            key={idx}
                    ...
                    {[
                        {
                            ...
                            color: "bg-rose-100",
                            image: getImagePath("/drone/franchise4.jpg")
                        },
                        {
                        ...
                        },
                        {
                            ...
                            color: "bg-green-100",
                            image: getImagePath("/drone/blog1.jpg")
                        },
                        {
                        ...
                        },
                        {
                            ...
                            color: "bg-pink-100",
                            image: getImagePath("/drone/franchise3.jpg")
                        },
                        {
                            ...
                            color: "bg-yellow-100",
                            image: getImagePath("/drone/new.jpg")
                        },
                    ].map((lab, idx) => (
                        <div
                            key={idx}
                ...
                <section className="py-12 px-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        },
                        {
                            ...
                            image: getImagePath("/3.png")
                        },
                    ].map((item, idx) => (
                        <div key={idx} className="bg-white rounded-xl shadow-md p-6">
                            <Image
                                src={getImagePath("/drone/tick.png")}
                                alt={item.title}
                                width={60}
                                height={60}
                                className="mb-3"
                ...
                <section className="bg-yellow-50 py-12 px-6 text-center">
                    ...
                    <div className="flex justify-center mt-6">
                        <Image
                            src={getImagePath("/drone/school5.png")}
